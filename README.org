...
** Module system
   ...
   #+END_SRC
** Type system
   Terp implements Hindley-Milner type inference. Currently, type checking is performed explicitly in the REPL; this will change in the future.

   To check the type of an expression, prefix it with =:t= or =:type= in the REPL:
